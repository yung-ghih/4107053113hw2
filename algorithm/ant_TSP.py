...
class AntColonyOptimizer:
    ...
    def fit(self, map_matrix, iterations=100, mode='min', early_stopping_count=20, verbose=True):
        ...
        # self.fit_time = round(time.time() - start)    # Time in minutes
        ...
        if mode == 'min':
            ...
            if verbose:
                print("ACO fitted.  Runtime: {} seconds.  Best score: {}".format(self.fit_time, self.best))
            return self.best, self.fit_time
        elif mode == 'max':
